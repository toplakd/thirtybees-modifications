...
<script>
$(function () {
    if ($(".cart_total_delivery").is(":hidden")) {
    $('#advanced_payment_options').hide();
    }
});
</script>

<div id="advanced_payment_options">
...
{if !$opc}
  {include file="$tpl_dir./shopping-cart.tpl" cannotModify = 1 advancedCheckout = 1 }
{/if}


<div id="checkbox_advanced">
...
<p class="cart_navigation clearfix">
  ...
  {/if}
  <button data-show-if-js="" style="" id="confirmOrder" type="button" class="btn btn-lg btn-success pull-right standard-checkout btn-full"><span>{l s='Order With Obligation To Pay'}</span></button>
  <a href="{$back_link|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btn btn-lg btn-default btn-full">
