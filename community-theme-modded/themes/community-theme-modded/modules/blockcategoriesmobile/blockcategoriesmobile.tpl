{if !empty($blockCategTree) && !empty($blockCategTree.children)}
    <section id="blockcategoriesmobile" class="blockcategoriesmobile block">
...
{literal}
    <script type="text/javascript">
        $(function () {
            ...
            $('.blockcategoriesmobile').each(function () {
                ...
                var $activeMenuLink = $('.mobile-list-group-item.current');
