...
<nav class="navbar navbar-inverse">
    <div class="container">
        {include file="$tpl_dir./header-mobile-menu.tpl"}
...
<header id="header">
    ...
    <div id="header-blocks" class="container">
        <div class="row">
            <div id="shop-logo" class="col-xs-12 col-sm-7 col-md-8">
...
<!-- added line for header-mobile-menu container -->
<div class="w3-overlay w3-animate-opacity" onclick="menu_toggle0()" id="myOverlay"></div>
